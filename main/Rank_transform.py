...
if __name__ == "__main__":
    parser= argparse.ArgumentParser(description="Rank_transform.py\n\
                                            calculates Mutual Ranks (MR) and Highest reciprocal ranks (HRR) and their standardized forms raw correlation scores.\n\
    ...
    parser.add_argument("-n", "--net_name" , type=str, metavar = "" , default = "All",
                        help = "name of the network to calculate MR and HRR for. By default, all networks will be calculated")
    ...
    parser.add_argument("-full", "--full_attributes" , type=str, metavar = "" , default = False,
    ...
    full_attributes = args.full_attributes
    ...
    for network_path in All_networks_paths:
        if full_attributes: #i.e. output full edge attributes 
